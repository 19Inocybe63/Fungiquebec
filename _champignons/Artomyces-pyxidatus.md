...
description:
  ...
  commentaires: |
    ...
    De Claude Kaufholtz-Couture. « Puisque les spores de <i>A. pyxidatus</i> sont petites, hyalines et mal définies dans l'eau glycérinée 20% et dans le NaCl iso 0,9%, elles se prêtent parfaitement à une préparation dans le permanganate de potassium (KMnO<sub>4</sub>) qui en détermine mieux les contours. »
  conidies: 
  conidiome: 
  conidiophores: 
  consistance: 
