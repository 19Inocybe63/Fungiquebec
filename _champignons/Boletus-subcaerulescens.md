...
description:
  ...
  chancre: 
  chapeau: convexe, glabre, cuticule collante
  cheilocystides: 
  cheilomacrocystides: 
  chlamydospores: 
  chrysocystides: 
  ...
  reactions-macrochimiques: |
    FeSO<SUB>4</SUB> = chair du chapeau et cuticule = verdâtre
    KOH 10% = rose sur les tubes rose ; cuticule = verdâtre ; chair = rosé ; stipe = mauve ; chair du stipe = mauve puis rougeâtre
    NH<SUB>4</SUB>OH 10% = rosé sur la chair du stipe et du chapeau ; stipe et cuticule = verdâtre
  receptacle: 
  remarques: 
  repartition: 
  rhizomorphes: 
