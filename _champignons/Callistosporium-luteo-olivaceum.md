...
description:
  ...
  columelle: 
  commentaires: |
    De Yves Lamoureux. « Ce qu'il y a de particulièrement intéressant avec ce PCJ est qu'une goutte de KOH 10% sur le pileus ou sur les lames le fait virer au rouge vif presque instantannément. Pas besoin de colorant au microscope non plus; tout est rouge. Alors si on a de la potasse, c'est une espèce facile à identifier, même si elle est très peu commune. »
  conidies: 
  conidiome: 
  conidiophores: 
  consistance: 
