...
description:
  ...
  basidiospores: |
    globuleuses à subglobuleuses, aculéolées (digitéolées) dont l’apex est obtus mesurant entre 1,3 [1,9; 2,5] 3,1 x 0,8 [1,3; 1,8] 2,3 µm, à paroi mince à légèrement épaissie, à contenu uniguttulé, brun pâle dans le NaCl iso 0,9%, légèrement rougeâtre dans le melzer, non cyanophiles
  ...
  synonymie: |
    ...
    Inocybella calospora (Quél.) Zerova, Viznachnik gribiv Ukraini. T. 5. Basidiomycetes:347 (1979)
    Inocybella calopsora (Quél.) Zerova (1979)
  systeme-hyphal: 
  textura: 
  tomentum-caulinaire: 
  tomentum-pileique: 
