...
description:
  ...
  cristaux: 
  cristaux-d-oxalate: 
  cristaux-apicaux: Dans l'observation des cristaux apicaux, j'ai relevé, avec une observation au 40x, que le sommet des cystides (lamprocheilocystides et lampropleurocystides) possède entre 1 et 2 (3) très petits subcrochets, plutôt une masse de cristaux
  cuticule: 
  cutis: 
  cycle: 
  cystides: 
