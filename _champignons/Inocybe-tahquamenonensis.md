...
description:
  ...
  commentaires: |
    ...
    De Claude Kaufholtz-Couture. « La description d’<i>Inocybe tahquamenonensis</i> d’après Kobayashi n’a absolument rien à voir avec la collection ici étudié. Les basidiospores chez Kobayashi sont beaucoup trop grandes, et ce dernier indique aussi que les cheilocystides sont similaires aux pleurocystides; ce qui n’est vraiment pas le cas dans cette étude. »
  conidies: 
  conidiome: 
  conidiophores: 
  consistance: 
  ...
  hypothece: 
  hysterothece: 
  lames: adnées, subespacées, pourprées, brunâtres à la fin, à arêtes violet-noir, dont l'arête est feutrée
  lamprocystides: 
