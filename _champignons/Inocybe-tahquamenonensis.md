...
description:
  ...
  commentaires: |
    ...
    De Claude Kaufholtz-Couture. « La description d’<i>Inocybe tahquamenonensis</i> d’après Kobayashi n’a absolument rien à voir avec la collection ici étudié (cKc0639). Les basidiospores chez Kobayashi sont beaucoup trop grandes, et ce dernier indique aussi que les cheilocystides sont similaires aux pleurocystides; ce qui n’est pas le cas dans cette étude. Suivant une étude d’ADN, je ne serais pas surpris de voir <i>I. tahquamenonensis</i> être placé dans un sous-genre distinct. »
