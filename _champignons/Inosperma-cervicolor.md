...
description:
  ...
  comestibilite: 
  commentaires: |
    De P. Brandon Matheny. « CKC0752 is a perfect match with <i>Inosperma cervicolor</i> sensu Vauras (TURA4761-see 4761 in tree attached for placement). It is sister to In. subrubescens sense meo. Sorting out subrubescens from cervicolor will still need to be done. »
  conidies: 
  conidiome: 
  conidiophores: 
  consistance: 
  ...
  receptacle: 
  remarques: récolté en grand nombre, plus de quarante collections; les codes de couleurs 5YR 3/3-4 font référence à la publication Munsell Soil-Color Charts.
  repartition: 
  rhizomorphes: 
  sac-sporifere: 
  saveur: 
