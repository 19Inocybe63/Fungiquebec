...
description:
  ...
  arete-lamellaire: 
  arthroconidies: 
  articles: "<b>Stubbe, Dirk, ; Verbeken, Annemieke</b>. <i>Lactarius subg. Plinthogalus,
    the European taxa and American varieties of L. lignyotus re-evaluated</i>, Mycologia,
    104(6), 2012, pp. 1490-1501, 12 p.\n"
  ascome: 
  ascospores: 
  asques: 
  asterohyphidies: 
  ...
  base-sterile: 
  base-stipitiforme: 
  basides: claviformes, tétrasporiques jusqu'à 10 µm de longueur, non bouclées à la
    base 55-60 x 14-15 µm en moyenne
  basidiospores: |
  ...
  chancre: 
  chapeau: 20-80 mm Ø, convexe, souvent papillé, puis étalé-déprimé, sec, velouté,
    brun noirâtre à brun jaunâtre
  ...
  hypothece: 
  hysterothece: 
  lames: adnées puis subdécurrentes, subespacées, blanches puis ochracées, à arêtes
    blanchâtres à brun-noir
  lamprocystides: 
  ...
  phialoconidies: 
  pied: 40-120 x 5-10 mm Ø, subégal à élargi vers la base ou parfois au milieu, légèrement
    comprimé au centre avec l'âge, plein puis farci, sec, velouté, souvent fortement
    plissé vers l'apex et avec fins sillons longitudinaux, concolore au chapeau ou
    plus pâle, blanc à la base
  pieds-steriles: 
  pigments: 
  ...
  receptacle: 
  remarques: Habituellement, la description du pileipellis indique que ce dernier
    est en épithélium avec hyphes terminales cylindriques ; mais après observation,
