...
description:
  ...
  basidiospores: |
    globuleuses, lisses à sublisses, à paroi mince à légèrement épaissie, sans pédicelle, à contenu uniguttulé à variable, hyalines à grisâtre pâle dans l’Eau glycérinée 20%, légèrement dextrinoïdes, non cyanophiles
    (3,4) 3,5 - 4 (4,1) × (3,3) 3,5 - 3,9 (4) µm
    Q = 1 (1,1) ; N = 30
    Me = 3,8 × 3,7 µm ; Qe = 1
    (Piximètre formule classique ; mesures dans E.G. 20% issues de sporées)
  basidioles: 
  ...
  commentaires: |
    ...
    De cKc. Il faut éviter d'inhaler les poussières laissées par les basidiospores. En trop grande quantité, une pneumonie inflammatoire peut se développer ; c'est la Lycoperdonosis. (Diaz, James H. Atlas of Human Poisoning and Envenoming, 2e Edition, 2015)
  conidies: 
  conidiome: 
  conidiophores: 
  consistance: 
