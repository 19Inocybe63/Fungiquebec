...
details:
  ...
  famille: Pluteaceae
  genre: Pluteus
  espece: <i>Pluteus longistriatus</i> (Peck) Peck
...
description:
  ...
  basidiome: 
  bibliographies: 
  biotopes: pousse sur les billes et débris de feuillus en décomposition
  boucles: 
  brachybasidioles: 
  calicule: 
  capillitium: 
  ...
  chair: pâle
  chancre: 
  chapeau: 10-20 mm Ø, convexe à légèrement campanulé, devenant globalement convexe à presque plat, fragile, sec, radialement finement granuleux ou squamuleux, développant des fissures qui s'étendent de la marge presque jusqu’au centre, gris-brun au gris brunâtre
  ...
  hypothece: 
  hysterothece: 
  lames: libres, larges, molles, serrées, blanchâtre d'abord, devenant rosé, dans des conditions chaudes et humides, elles s'effondrent ou se dissolvent souvent
  lamprocystides: 
  ...
  syndrome: 
  synonymie: |
    <i>Agaricus longistriatus</i> Peck, Annual Report on the New York State Museum of Natural History 30:40 (1878)
  systeme-hyphal: 
  textura: 
  tomentum-caulinaire: 
  tomentum-pileique: 
