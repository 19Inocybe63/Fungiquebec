...
description:
  ...
  basides: 
  basidiospores: |
    globuleuses (4,8 %) à subglobuleuses (76,1 %), à largement elliptiques (19,1 %), proéminences entre 0,2-0,5 µm, avec verrues, rides et connexifs formant un réticulum
  ...
  basidiome: 
  bibliographies: 
  biotopes: pousse au sol, sous les conifères
  boucles: 
  brachybasidioles: 
  calicule: 
  capillitium: 
  ...
  dermatocystides-caulocystides-et-pileipellis: sulfobenzaldéhyde + (SBA+)
  derniere-correction: 
  dicaryophyses: 
  dichophyses: 
  disque-basal: 
