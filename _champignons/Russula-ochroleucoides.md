...
description:
  ...
  arthroconidies: 
  articles: |
    Kaufholtz-Couture, Claude. Les différentes intensités causées par la réaction au soluté alcoolique officinal de résine de gaïac ; (soluté de gaïac), Édition Fungiquebec, Québec 2014, 4 p.
  ascome: 
  ascospores: 
  asques: 
  asterohyphidies: 
