...
description:
  ...
  basidiome: 
  bibliographies: 
  biotopes: pousse au sol, sous feuillus <i>Fagus</i>, <i>Quercus</i>
  boucles: 
  brachybasidioles: 
  calicule: 
  capillitium: 
  ...
  excipulum-ectal: 
  exhalaison: persil (persil italien)
  ...
  hypothece: 
  hysterothece: 
  lames: adnées à subdécurrentes, serrées à très serrées, fragiles, sans lamelles ni lamellules, fourchues près du pied, blanches
  lamprocystides: 
  latex: 
  leptocystides: 
  macrocystides: 
  ...
  medulla-clavulaire: 
  microconidies: 
  mode-de-croissance: solitaire ou en petit groupe
  mycelium-basal: 
  myxocarpe: 
  nouvelle-espece: 
  note-taxonomique: 
  ...
  pileitrame: 
  pileocystides: 
  pileus: 20-50 mm Ø, convexe puis subétalé, déprimé, rosâtre au début, visqueux à l'humidité, parfois pruineux au sec, lisse à légèrement plissé, cuticule pelant jusqu'aux 1/3 du rayon, bleu-vert à bleu-vert grisâtre
  plasmode: 
  ...
  rhizomorphes: 
  sac-sporifere: 
  saveur: douce; de persil (persil italien)
  sclerocystides: 
  sclerote: 
  soies: 
  soies-hymeniales: 
  ...
  spherocytes: 
  sporocystes: 
  stipe: 30-48 x 9-14 mm Ø, légèrement claviforme à égal, parfois atténué vers la base, farci au début et devenant vide à maturité, sec, lisse, blanc, parfois très légèrement teinté de verdâtre à maturité, grisonnant au froissement
  stipitipellis: 
  stipititrame: 
  stroma: 
  subhymenium: 
