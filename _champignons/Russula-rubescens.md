...
description:
  ...
  basidiospores: |
    obtusément elliptiques à largement elliptiques, verruqueuses-échinulées, avec quelques rares connexifs, avec proéminence jusqu'à 1 µm (1,3) de hauteur, à paroi mince, appendice hilaire pas toujours bien visible, ainsi que la plage hilaire 2,4-3,1 en moyenne, à contenu uniguttulé, hyalines dans le NaCl iso 0,9%, amyloïdes
  ...
  soies: 
  soies-hymeniales: 
  sporee: ochrosporée IIIa-IIIb, ocre pâle à ocre moyen, d'après la charte de couleur Romagnesi; D-E d'après la charte de couleur de Kibby
  spherocytes: 
  sporocystes: 
  stipe: 34-56 x 7-18 mm Ø, claviforme, farci, blanc, rougit puis grisonne au grattage
  stipitipellis: 
  stipititrame: 
  stroma: 
  subhymenium: 
